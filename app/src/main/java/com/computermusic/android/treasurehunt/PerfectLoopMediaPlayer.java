...
public class PerfectLoopMediaPlayer {
    ...
    private float currLeftVol = 1;
    private float currRightVol =1;
...
//                    mCurrentPlayer.start();
    ...
    private void createNextMediaPlayerRaw() {
        ...
        mNextPlayer.setVolume(this.currLeftVol,this.currRightVol);
        try {
...
//                    mCurrentPlayer.start();
    ...
    public void setVolume(float leftVolume, float rightVolume) {
        if (mCurrentPlayer != null) {
            ...
            this.currLeftVol = leftVolume;
            this.currRightVol = rightVolume;
        } else {
            Log.d(TAG, "setVolume()");
        }
